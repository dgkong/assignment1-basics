...
def run_multihead_self_attention(
    ...
    """
    multihead_attn = MultiHeadSelfAttention(d_model, num_heads)
    state_dict = {"query.weight": q_proj_weight, "key.weight": k_proj_weight, "value.weight": v_proj_weight, 
                  "output.weight": o_proj_weight}
    multihead_attn.load_state_dict(state_dict)
...
def run_multihead_self_attention_with_rope(
    ...
    Returns:
        ...
        implementation with the given QKV projection weights and input features.
    """
    multihead_attn = MultiHeadSelfAttention(d_model, num_heads, max_seq_len, theta)
    state_dict = {"query.weight": q_proj_weight, "key.weight": k_proj_weight, "value.weight": v_proj_weight, 
                  "output.weight": o_proj_weight}
    multihead_attn.load_state_dict(state_dict)
